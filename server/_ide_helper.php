 ...
 */
     ...
     */ 
        ...
        {
                        return \Illuminate\Http\Request::model($name);
        }
                    /**
         * 
         *
        ...
        {
                        return \Illuminate\Http\Request::owner();
        }
                    /**
         * 
         *
        ...
        {
                        return \Illuminate\Http\Request::client();
        }
                    /**
         * 
         *
     ...
     */ 
         ...
         *
         * @return array 
         * @see \Avidianity\LaravelExtras\Providers\LaravelExtrasServiceProvider::boot()
         * @static 
         */ 
