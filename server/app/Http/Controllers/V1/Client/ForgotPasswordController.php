...
use App\Http\Requests\V1\Client\ForgotPassword\FinalizeRequest;
use App\Http\Requests\V1\Client\ForgotPassword\SendRequest;
use App\Http\Requests\V1\Client\ForgotPassword\VerifyRequest;
...
class ForgotPasswordController extends Controller
{
    ...
    protected function getUser(string $email): ?Client
    {
