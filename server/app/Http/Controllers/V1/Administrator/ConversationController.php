    ...
    public function send(SendRequest $request)
    {
        ...
        switch ($type) {
            case MessageType::TEXT:
                $message = $this->service->sendText($administrator, $model, $request->validated('message_text'));
                break;
            case MessageType::FILE:
                $message = $this->service->sendFile($administrator, $model, $request->file('message_file'));
                break;
        }
