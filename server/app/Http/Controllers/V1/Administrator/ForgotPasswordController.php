...
use App\Http\Requests\V1\Administrator\ForgotPassword\FinalizeRequest;
use App\Http\Requests\V1\Administrator\ForgotPassword\SendRequest;
use App\Http\Requests\V1\Administrator\ForgotPassword\VerifyRequest;
...
class ForgotPasswordController extends Controller
{
    ...
    protected function getUser(string $email): ?Administrator
    {
        return Administrator::whereEmail($email)->first();
    }
}
