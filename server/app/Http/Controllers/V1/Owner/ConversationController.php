...
class ConversationController extends Controller
{
    ...
    public function store(StoreRequest $request)
    {
        ...
        $conversation = $this->service->make($owner, $model, $pond);
    ...
    public function send(SendRequest $request)
    {
        ...
        switch ($type) {
            case MessageType::TEXT:
                $message = $this->service->sendText($owner, $model, $pond, $request->validated('message_text'));
                break;
            case MessageType::FILE:
                $message = $this->service->sendFile($owner, $model, $pond, $request->file('message_file'));
                break;
        }
